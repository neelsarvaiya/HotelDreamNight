                        ...
                        <form action="user-profile.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="card-body col-lg-4">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <img src="img/userProfile/<?= $result['Profile_pic'] ?>" class="img-fluid rounded-circle" style="height: 300px; width: 40%;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="pin" class="form-label">Enter State: </label>
                ...
                <div class="card mb-4 border-0 shadow rounded-3 p-2">
                    <div class="card-body">
                        ...
                        <form action="user-profile.php" method="post">
                            ...
                            <button type="submit" name="pass_btn" class="btn text-white custom-bg shadow-none">Save Changes</button>
                        </form>
                    </div>
                </div>
            </div>
