    ...
    <div class="col-lg-2 bg-dark border-top border-3 border-secondary" id="dashbord-menu" style="position: fixed;">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid flex-lg-column align-items-stretch">
                <h4 class="mt-2 text-light h-font fs-5">ADMIN DASHBORD</h4>
                ...
                <div class="offcanvas offcanvas-start text-bg-dark" id="adminbar" style="width: 300px;">
                    <div class="offcanvas-header">
                        <h1 class="offcanvas-title fs-2 h-font fs-5">ADMIN DASHBORD</h1>
                    ...
                    <div class="offcanvas-body bg-dark">
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="User-query & Contact.php"><i class="bi bi-person-lines-fill text-danger"></i> User-query & Contact</a>
                            </li>
                            <li class="nav-item">
