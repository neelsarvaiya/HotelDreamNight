    ...
    <div class="card otp-card">
        <div class="card-body p-4">
            ...
            <form action="otp_form.php" method="post">
                <div class="d-flex justify-content-center mb-4 " data-validation="required" name="otp">
                    <input type=" text" class="form-control otp-input me-2" maxlength="1" autofocus oninput="moveToNext(this, 0)" name="otp1">
                    <input type="text" class="form-control otp-input me-2" maxlength="1" oninput="moveToNext(this, 1)" name="otp2">
                    <input type="text" class="form-control otp-input me-2" maxlength="1" oninput="moveToNext(this, 2)" name="otp3">
                    <input type="text" class="form-control otp-input me-2" maxlength="1" oninput="moveToNext(this, 3)" name="otp4">
                    <input type="text" class="form-control otp-input me-2" maxlength="1" oninput="moveToNext(this, 4)" name="otp5">
                    <input type="text" class="form-control otp-input me-2" maxlength="1" oninput="moveToNext(this, 5)" name="otp6">
                </div>
                ...
                <script>
                    ...
                    let timeLeft = 20; // Default timer value
                    ...
                    resendButton.onclick = function(event) {
                        ...
                        sessionStorage.setItem('otpTimer', 20); // Reset timer
